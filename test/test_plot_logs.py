...
def test_parse_log_current_coupling_format_and_ignore_noise(tmp_path: Path) -> None:
    log_text = "\n".join(
        [
            ...
            "_run_training_phase - epoch 1 | train loss=9.4756e-03 l2_cons=6.0632e-03 energy_cons=3.4125e-01 cross_cons=7.5000e-02 rel_flux=1.0129e+00 rel_sol=1.5867e+00 | w_l2=1.0000e+00 on_l2=True w_energy=1.0000e-02 on_energy=True w_cross=5.0000e-01 on_cross=False | lr=1.0000e-03 smooth_mask_diff_power=7.5000e-01 | val loss=1.0300e-02 l2_cons=6.7485e-03 energy_cons=3.5588e-01 cross_cons=8.2000e-02 rel_flux=1.0224e+00 rel_sol=1.5545e+00",
