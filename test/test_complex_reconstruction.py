...
from greenonet.complex_reconstruction import reconstruct_from_projected_physical
...
def test_complex_reconstruction_owns_length_pullback_and_zero_endpoints(tmp_path):
    ...
    projected_physical = torch.tensor(
        [[[2.0, 4.0, 24.0], [10.0, 20.0, 30.0]]],
        dtype=torch.float64,
    )

    result = reconstruct_from_projected_physical(
