...
class GreenLearningDatasetGenerator:
    ...
    def __init__(
        ...
        save_path: Union[str, Path] = "Examples/helmholtz.npz",
        lambda_: float = 0.03,
        linear: bool = True,
    ):
        """
        ...
        self.Nsample = self.Nf - 4  # Number of samples to generate
    ...
    def generate_dataset(self):
        ...
        for i in range(self.Nsample):
            ...
            u = solve_bvp(
                fun, bc, domain, np.zeros((2, domain.size)), tol=1e-14, bc_tol=1e-16
            ).sol(domain)
