...
class Loss:
    ...
    def __call__(
        self, green_output: torch.Tensor, hom_output: torch.Tensor
    ) -> torch.Tensor:
        """
        ...
        hom_output : torch.Tensor
            The output tensor from the homogeneous solution model.
        ...
        residual = self.u - integ_green_rhs - hom_output
...
if __name__ == "__main__":
    ...
    print(loss(green_output, hom_output))
